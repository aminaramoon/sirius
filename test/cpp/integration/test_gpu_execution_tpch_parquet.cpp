 ...
 public:
                          ...
                          std::optional<float> float_tolerance = std::nullopt)
  {
    ...
    if (gpu_result->HasError()) {
      UNSCOPED_INFO("parquet gpu_execution error: " << gpu_result->GetError());
    }
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - scan single column",
                 "[integration][parquet][gpu_execution][scan]")
{
  compare_gpu_vs_cpu("select n_nationkey from nation;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - scan multiple columns",
                 "[integration][parquet][gpu_execution][scan]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - scan region table",
                 "[integration][parquet][gpu_execution][scan]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - projection add",
                 "[integration][parquet][gpu_execution][projection]")
{
  compare_gpu_vs_cpu("select n_nationkey + n_regionkey as total from nation;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - projection multiply",
                 "[integration][parquet][gpu_execution][projection]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - filter equality",
                 "[integration][parquet][gpu_execution][filter]")
{
  compare_gpu_vs_cpu("select n_nationkey from nation where n_regionkey = 1;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - filter greater than",
                 "[integration][parquet][gpu_execution][filter]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - filter not equal",
                 "[integration][parquet][gpu_execution][filter]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - filter with projection",
                 "[integration][parquet][gpu_execution][filter]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - ungrouped min max",
                 "[integration][parquet][gpu_execution][aggregate]")
{
  compare_gpu_vs_cpu("select min(n_regionkey), max(n_nationkey) from nation;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - ungrouped min with filter",
                 "[integration][parquet][gpu_execution][aggregate]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - ungrouped sum count",
                 "[integration][parquet][gpu_execution][aggregate]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - ungrouped all agg functions",
                 "[integration][parquet][gpu_execution][aggregate]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - ungrouped avg integer",
                 "[integration][parquet][gpu_execution][aggregate][avg]")
{
  compare_gpu_vs_cpu("select avg(n_nationkey) from nation;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - ungrouped avg decimal",
                 "[integration][parquet][gpu_execution][aggregate][avg]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - single group by key: min max, sum, count(*)",
                 "[integration][parquet][gpu_execution][grouped_aggregate]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - single group by key: min max, count string ",
                 "[integration][parquet][gpu_execution][grouped_aggregate]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(
  ...
  "parquet gpu_execution - two group by key: min max, but not showing the group by keys",
  "[integration][parquet][gpu_execution][grouped_aggregate]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - two group keys and noaggregations",
                 "[integration][parquet][gpu_execution][grouped_aggregate]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - limit",
                 "[integration][parquet][gpu_execution][limit]")
{
  compare_gpu_vs_cpu("select n_nationkey from nation limit 10;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - limit with filter",
                 "[integration][parquet][gpu_execution][limit]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - limit on large table",
                 "[integration][parquet][gpu_execution][limit][limit_multi_batch]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - limit with offset on large table",
                 "[integration][parquet][gpu_execution][limit][limit_multi_batch]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic inner join 0",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic inner join 1",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic inner join 2",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic inner join 3",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic left join 0",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic left join 1",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_custkey, c.c_name  from nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic left join 2",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  from nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic left join 3",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic left join 0 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic left join 1 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_custkey, c.c_name  from nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic left join 2 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  from nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic left join 3 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_name, c.c_custkey, c.c_name  from nation n left join customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic right join 0",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic right join 1",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_custkey, c.c_name  from nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic right join 2",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  from nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic right join 3",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic right join 0 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic right join 1 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_custkey, c.c_name  from nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic right join 2 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  from nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic right join 3 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_name, c.c_custkey, c.c_name  from nation n right join customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped inner join 0",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped inner join 1",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped inner join 2",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped inner join 3",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped left join 0",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped left join 1",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_custkey, c.c_name  from customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped left join 2",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  from customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped left join 3",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped left join 0 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped left join 1 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_custkey, c.c_name  from customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped left join 2 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  from customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped left join 3 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_name, c.c_custkey, c.c_name  from customer c left join nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped right join 0",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped right join 1",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_custkey, c.c_name  from customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped right join 2",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  from customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped right join 3",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped right join 0 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped right join 1 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey, c.c_custkey, c.c_name  from customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped right join 2 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_regionkey, c.c_nationkey, c.c_custkey, c.c_name  from customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped right join 3 making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_name, c.c_custkey, c.c_name  from customer c right join nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic full outer join",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic full outer join making nulls",
                 "[integration][parquet][gpu_execution][join]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, r.r_regionkey from nation n full outer join region r "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic left semi join",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic left semi join 2",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic right semi join",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic right semi join 2",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic semi join 3",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic semi join 4",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic semi join 5",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic semi join misfit 0",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
    "select n.n_nationkey, n.n_regionkey  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - basic semi join mistit 1",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
    "select n.n_regionkey  from nation n "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped semi join 0",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped semi join 1",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped semi join misfit 0",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
    "select c.c_nationkey, c.c_custkey, c.c_name  "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - swapped semi join misfit 1",
                 "[integration][parquet][gpu_execution][semijoin]")
{
  compare_gpu_vs_cpu(
    "select c.c_custkey, c.c_name  from customer c "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - bigger inner join",
                 "[integration][parquet][gpu_execution][bigger_join]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - bigger left join",
                 "[integration][parquet][gpu_execution][bigger_join]")
{
  compare_gpu_vs_cpu(
    "select l.l_orderkey, l.l_linenumber, l.l_quantity, l.l_partkey, o.o_orderkey, o.o_totalprice, "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - bigger right join",
                 "[integration][parquet][gpu_execution][bigger_join]")
{
  compare_gpu_vs_cpu(
    "select l.l_orderkey, l.l_linenumber, l.l_quantity, l.l_partkey, o.o_orderkey, o.o_totalprice, "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - bigger full outer join",
                 "[integration][parquet][gpu_execution][bigger_join]")
{
  compare_gpu_vs_cpu(
    "select l.l_orderkey, l.l_linenumber, l.l_quantity, l.l_partkey, o.o_orderkey, o.o_totalprice, "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - two group by key: min max, sum, count of doubles",
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - filter returns empty result",
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - group by count",
                 "[integration][parquet][gpu_execution][group_by]")
{
  compare_gpu_vs_cpu("select n_regionkey, count(*) from nation group by n_regionkey;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - group by min max count",
                 "[integration][parquet][gpu_execution][group_by]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - group by avg integer",
                 "[integration][parquet][gpu_execution][group_by][avg]")
{
  compare_gpu_vs_cpu("select n_regionkey, avg(n_nationkey) from nation group by n_regionkey;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - group by avg with other aggregates",
                 "[integration][parquet][gpu_execution][group_by][avg]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - group by avg decimal",
                 "[integration][parquet][gpu_execution][group_by][avg]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - group by sum avg on lineitem",
                 "[integration][parquet][gpu_execution][group_by][avg]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by",
                 "[integration][parquet][gpu_execution][order_by]")
{
  compare_gpu_vs_cpu("select n_nationkey, n_regionkey from nation order by n_regionkey;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by column not in select",
                 "[integration][parquet][gpu_execution][order_by][order_by_proj]")
{
  compare_gpu_vs_cpu("select n_nationkey from nation order by n_regionkey;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by column not in select lineitem",
                 "[integration][parquet][gpu_execution][order_by][order_by_proj]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by multipartition",
                 "[integration][parquet][gpu_execution][order_by]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by multiple columns",
                 "[integration][parquet][gpu_execution][order_by]")
{
  con->Query("SET max_sort_partition_bytes = 1024;");
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by desc",
                 "[integration][parquet][gpu_execution][order_by]")
{
  con->Query("SET max_sort_partition_bytes = 1024;");
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by many selected columns",
                 "[integration][parquet][gpu_execution][order_by]")
{
  con->Query("SET max_sort_partition_bytes = 1024;");
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by with decimal column",
                 "[integration][parquet][gpu_execution][order_by][order_by_types]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - scan lineitem with varchar column",
                 "[integration][parquet][gpu_execution][varchar_scan_lineitem]")
{
  compare_gpu_vs_cpu("select l_orderkey, l_shipinstruct from lineitem;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by lineitem with short varchar column",
                 "[integration][parquet][gpu_execution][order_by][varchar_order]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by lineitem with long varchar column",
                 "[integration][parquet][gpu_execution][order_by][varchar_order]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - scan with varchar column",
                 "[integration][parquet][gpu_execution][order_by_types][varchar]")
{
  compare_gpu_vs_cpu("select n_nationkey, n_name from nation;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - order by with varchar column",
                 "[integration][parquet][gpu_execution][order_by][order_by_types]")
{
  auto gpu_result =
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - cast integer to decimal preserves scale",
                 "[integration][parquet][gpu_execution][cast][decimal]")
{
  compare_gpu_vs_cpu("select n_nationkey, cast(n_nationkey as Decimal(18,2)) as d from nation;");
}

TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - cast integer to decimal with aggregation",
                 "[integration][parquet][gpu_execution][cast][decimal]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - cast to decimal different scales",
                 "[integration][parquet][gpu_execution][cast][decimal]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - issue 227 cast decimal with avg and group by",
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - count distinct: single group key",
                 "[integration][parquet][gpu_execution][group_by][count_distinct]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - count distinct: string column",
                 "[integration][parquet][gpu_execution][group_by][count_distinct]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - count distinct: mixed with min and count",
                 "[integration][parquet][gpu_execution][group_by][count_distinct]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - count distinct: larger table two group keys",
                 "[integration][parquet][gpu_execution][group_by][count_distinct]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - count distinct: multi-partition forced, single group key",
                 "[integration][parquet][gpu_execution][group_by][count_distinct][multi_partition]")
{
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - count distinct: multi-partition forced, customer table",
                 "[integration][parquet][gpu_execution][group_by][count_distinct][multi_partition]")
{
...
TEST_CASE_METHOD(
  GPUExecutionParquetFixture,
  "parquet gpu_execution - count distinct: multi-partition forced, mixed aggregations",
  "[integration][parquet][gpu_execution][group_by][count_distinct][multi_partition]")
{
  PartitionSizeGuard guard(1000);
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - count distinct: multi-column struct",
                 "[integration][parquet][gpu_execution][group_by][count_distinct]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(
  GPUExecutionParquetFixture,
  "parquet gpu_execution - count distinct: multi-column struct, multi-partition forced",
  "[integration][parquet][gpu_execution][group_by][count_distinct][multi_partition]")
{
  PartitionSizeGuard guard(5);
  compare_gpu_vs_cpu(
...
//===----------------------------------------------------------------------===//
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 1",
                 "[integration][parquet][gpu_execution][TPC-H][Q1]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 2",
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 3",
                 "[integration][parquet][gpu_execution][TPC-H][Q3]")
{
  compare_gpu_vs_cpu(
    "select l.l_orderkey, "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 4",
                 "[integration][parquet][gpu_execution][TPC-H][Q4]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 5",
                 "[integration][parquet][gpu_execution][TPC-H][Q5]")
{
  compare_gpu_vs_cpu(
    "select n.n_name, "
    "sum(l.l_extendedprice * (1 - l.l_discount)) as revenue "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 6",
                 "[integration][parquet][gpu_execution][TPC-H][Q6]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 7",
                 "[integration][parquet][gpu_execution][TPC-H][Q7]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 8",
                 "[integration][parquet][gpu_execution][TPC-H][Q8]")
{
  compare_gpu_vs_cpu(
    "select o_year, "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 9",
                 "[integration][parquet][gpu_execution][TPC-H][Q9]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 10",
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 11",
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 12",
                 "[integration][parquet][gpu_execution][TPC-H][Q12]")
{
  compare_gpu_vs_cpu(
    "select l.l_shipmode, "
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 13",
                 "[integration][parquet][gpu_execution][TPC-H][Q13]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 14",
                 "[integration][parquet][gpu_execution][TPC-H][Q14]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 15",
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 16",
                 "[integration][parquet][gpu_execution][TPC-H][Q16]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 17",
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 18",
                 "[integration][parquet][gpu_execution][TPC-H][Q18]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 19",
                 "[integration][parquet][gpu_execution][TPC-H][Q19]")
{
  compare_gpu_vs_cpu(
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 20",
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 21",
...
TEST_CASE_METHOD(GPUExecutionParquetFixture,
                 "parquet gpu_execution - TPC-H Query 22",
